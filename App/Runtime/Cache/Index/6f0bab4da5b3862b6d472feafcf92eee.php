   ...
   <meta name="viewport" content="width=device-width, initial-scale=1" />
	...
	<body>
			...
			<div class="main ">
					...
					<div class='panel panel-default bk-bg-white'>
								<div class='panel-heading bk-bg-white'>
									<h6><i class='fa fa-indent red'></i>会议室预约信息填写</h6>							
								...
								<div class='panel-body' style=''>
									<form id="myform" method='POST' enctype='multipart/form-data' class='form-horizontal' action="<?php echo U('Index/Order/view');?>" onsubmit="return PostData()">
										<div class='form-group'>
											<label class='col-md-3 control-label' for='text-input'>预约人</label>
											<div class='col-md-9'>
												<input type='text' id='id2' name='p_dep' class='form-control' placeholder='教师xxx'>
												<span class='help-block'></span>
											</div>
										</div>
										<div class='form-group'>
											<label class='col-md-3 control-label' for='text-input'>预约事由</label>
											<div class='col-md-9'>
												<input type='text' id='id1' name='p_reason' class='form-control' placeholder='开组会'>
												<input type="hidden" name="p_housename" id="housename" value="<?php echo ($housename); ?>">
												<input type="hidden" name="p_date" id="date" value="<?php echo ($date); ?>">
												<input type="hidden" name="p_time" id="time" value="<?php echo ($time); ?>">
												<input type="hidden" name="Submit" id="flag" value="<?php echo ($flag); ?>">
												<span class='help-block'></span>
											</div>
										</div>
									    ...
									    <div class='form-group'>
											...
											<div class='col-md-9'>
												<input type='text' id='id3' name='p_tel' class='form-control' placeholder=''>
												<span class='help-block'></span>
											</div>
										</div>
										<div class='form-group' >
											<label class='col-md-3 control-label' for='text-input'>联系E-mail</label>
											<div class='col-md-9'>
												<input type='text' id='id4' name='p_email' class='form-control' placeholder=''>
												<span class='help-block'></span>
											</div>
										</div>
									...
									<!--button type="submit">tijioa</button-->
									<button type="submit" class='bk-margin-5 btn btn-danger btn-a' style='margin-left:45%'>提交</button>
									</div>
		...
		<script type="text/javascript">
			...
			function PostData(){
				$("#myform").ajaxSubmit({
					url:"<?php echo U('Index/Order/view');?>",
					type:"POST",
					success:function(data){
						...
						if(data.status == 1) {
							...
							console.log("yu yue cheng gong!")
								//setTimeout(function() {
							location.href = "<?php echo U('Index/Order/index');?>";
								//}, 1 * 1000);
						}
						else{
